...
```{r}
df3 <- datos_agregados %>% mutate(sp = X/N )
```
...
ggplot(df3, aes( x=t, y = sp)) + geom_point(color='red', size=2) + 
...
# dfAerolineasSeveridad <- dfAerolineasSeveridad[order(dfAerolineasSeveridad$s, decreasing_año= T),]
...
# library(cowplot)
# 
# graficoAerolineasSeveridad <-  graficoAerolineasSeveridad +  theme_cowplot(8) +  theme(plot.title=element_text(hjust=0.5),
...
# 
# #Se ordena de forma descendente por monto total reclamado.
# dfReclamosSeveridad <- dfReclamosSeveridad[order(dfReclamosSeveridad$s, decreasing_año= T),]
# #Se toman las 5 aerolineas con mayor monto de reclamos promedio.
# 
# dfReclamosSeveridad <- dfReclamosSeveridad[1:5,]
# 
#  dfReclamosSeveridad$claim_type[3] <- "No especifica"
# 
...
# library(cowplot)
# 
# graficoReclamosSeveridad <-  graficoReclamosSeveridad +  theme_cowplot(8) + theme(plot.title=element_text(hjust=0.5),
#           plot.subtitle=element_text(hjust=0.5))
# 
#  graficoReclamosSeveridad
# 
