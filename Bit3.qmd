...
cdfcomp(cex=0.8, list(fit_Binom, fit_ZTBinom, fit_ZMBinom), main="Ajustes distribución binomial", xlab="Datos de frecuencia", ylab = "Función de distribución", legend=c("Binomial","Truncada","Modificada"))
...
cdfcomp(cex=0.8, list(fit_lnorm, fit_exp, fit_gamma, fit_JSU, fit_glogis, fit_weibull), 
        legendtext = plot.legend)
```

En la @tbl-parametrosSeveridad se muestran los parámetros ajustados para
cada modelo.
