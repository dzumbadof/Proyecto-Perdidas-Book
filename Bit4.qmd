...
# wpar <- n2w(c(400,400,400),c(0.75,1.25,0.75)/3)
# wpar <- n2w(c(100,200,300),c(1,1,1)/3)

# wpar <- n2w(c(300,300),c(0.5, 0.5))

# wpar <- n2w(c(90,100,90,55),c(0.5,1.5,1.5,0.5)/4) # valor p 17.51% con 4 P
# wpar <- n2w(c(90,100,90,55),c(0.1,0.4,0.3,0.1)) # valor p 17%
...
# wpar <- n2w(c(90,100,90,55),c(0.5,1.2,1.5,0.8)/4) # 7%
...
hist(datos_agregados$N, probability = T)
lines(density(datos_agregados$N))
